  ...
  <div className='bg-primary/60 h-full'>
    ...
    <div className='w-full h-full bg-gradient-to-r from-primary/10 via-black/30 to-black/10'>
      <div className='text-center flex flex-col justify-center xl:pt-40 xl:text-left h-full container mx-auto'>
        ...
        className='h1'>
          <Balancer>
          Transforming Ideas <br/> Into <span className='text-cubes'>Digital Reality</span>
          </Balancer>
        </motion.h1>
        {/* subtitle */}
        <motion.p 
        ...
        >
          Hi, my name is Isaque Sene, I m a Web & Software Developer.
        </motion.p>
        {/* btn */}
        <div className="flex z-30 justify-center xl:hidden relative">
          <ProjectsBtn/>
        </div>
    ...
    <div className="w-[1200px] h-full absolute right-0 bottom-0">
      {/* bg img */}
      <div className="bg-none xl:bg-cube xl:bg-cover xl:bg-right xl:bg-no-repeat w-full h-full
